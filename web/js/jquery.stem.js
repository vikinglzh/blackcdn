...
var diko = {
	...
	mobile: {
		...
		xiaoshuo: function() {
			diko.browser.useragent.weixin ? $("#xiao").after('<li><a rel="nofollow" href="https://mp.weixin.qq.com/mp/profile_ext?action=home&__biz=MzU4NTY2OTQ3Ng==&scene=126&bizpsid=0#wechat_redirect" target="_blank">小说</a></li>') : $("#xiao").after()
		}
	},
	swiper: function() {
		$.getScript("https://cdn.jsdelivr.net/gh/vikinglzh/blackcdn@master/web/js/swiper.min.js", function() {
	...
	wrapper: function() {
		var windowWidth = $(window).width();
		if (windowWidth < 820) {
		$.getScript("https://cdn.jsdelivr.net/gh/vikinglzh/blackcdn@master/web/js/iscroll.js", function() {
	...
	shorturl: function(){
		var short = $("#short");
		var short2 = $("#short2");
		var url2 = "https://www.baidu.com/s?wd=%E9%A1%B6%E7%A9%BA%E5%BD%B1%E8%A7%86dikotv";
	...
	images: {
		lazyload: function() {
			$.getScript("https://cdn.jsdelivr.net/gh/vikinglzh/blackcdn@master/web/js/jquery.lazyload.min.js", function() {
				$(".lazyload").lazyload({
					effect: "fadeIn",
					threshold: 200,
					failurelimit: 20,
		...
		qrcode: function() {
			$.getScript("https://cdn.jsdelivr.net/gh/vikinglzh/blackcdn@master/web/js/jquery.qrcode.min.js", function() {
				$(".cans").qrcode({
					width:120,
					height:120,
	...
	copy: function() {
		$.getScript("https://cdn.jsdelivr.net/gh/vikinglzh/blackcdn@master/web/js/clipboard.min.js", function() {
...
$(document).ready(function() {
	diko.browser.useragent.mobile && (diko.mobile.share(), diko.mobile.xiaoshuo());
	diko.swiper();
	diko.menu();
	diko.fixed();
	diko.Search();
