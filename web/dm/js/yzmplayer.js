...
function() {
    ...
    function(e, t, n) {
        ...
        Y = function() {
            ...
            default(this),
                ...
                c.
            default.isMobile && this.container.classList.add("yzmplayer-mobile"),
            ...
            default(this.template.bezel),
                this.fullScreen = new S.
            default(this),
                this.controller = new F.
            default(this),
                this.options.danmaku && (this.danmaku = new b.
            default({
                    container:
            ...
            return o(e, [{
                ...
                value: function(e) {
                    ...
                    this.video.currentTime < e ? this.notice(this.tran("快进") + " " + (e - this.video.currentTime).toFixed(0) + " " + this.tran("秒")) : this.video.currentTime > e && this.notice(this.tran("后退") + " " + (this.video.currentTime - e).toFixed(0) + " " + this.tran("秒")),
            ...
            },
            {
                ...
                default.pause),
                    this.ended = !1,
                    this.template.playButton.innerHTML = v.
                default.play,
                    this.video.pause(),
            ...
            },
            {
                ...
                value: function(e, t, n) {
                    if (e = parseFloat(e), !isNaN(e)) {
                        ...
                        n || this.notice(this.tran("音量") + " " + (100 * e).toFixed(0) + "%"),
                        this.video.volume = e,
            ...
            },
            {
                ...
                value: function(e, t) {
                    ...
                    function() {
                        ...
                        n.setting.loop ? (n.seek(0), e.play()) : (n.ended = !0, n.pause()),
                    ...
                    this.options.subtitle && (this.subtitle = new _.
                    ...
                    function i(e, s) {
                        try {
                            if (s && ("object" === (void 0 === s ? "undefined": d(s)) || "function" == typeof s)) {
                                var r = s.then;
                                if ("function" == typeof r) return void r.call(s,
                                function(t) {
                                    i(e, t)
                                },
                                n)
    ...
    function(e, t, n) {
        ...
        function s(e) {
            ...
            if ((p === a || !p) && clearTimeout) return p = clearTimeout,
            clearTimeout(e);
            try {
                return p(e)
            } catch(t) {
    ...
    default = function(e) {
            ...
            e.contextmenu = e.contextmenu.concat([{
                text: "微信公众号",
                link: "https://weixin.sogou.com/weixin?type=1&query=%E9%A1%B6%E7%A9%BA&ie=utf8&s_from=input&_sug_=n&_sug_type_="
            },
            {
                text: "顶空影视",
                link: "https://www.dikotv.com/"
            }]),
            e
        }
    },
    ...
    function(e, t, n) {
        ...
        e.exports = function(e) {
            ...
            e.$value,
            e.$index;
            return t += '<div id="loading-box"><div class="loading"><p class="pic"></p><div class="tips"></div></div><div type="button" id="close" ><span id="link1" style="font-weight: bolder;" >——顶空影视——</span><span id="link2" style="color: red;font-weight: bolder;">请勿相信水印广告</br>缓冲失败再切换线路</span><span id="link2-success">弹幕已填装完毕</span><span id="link2-error">弹幕连接失败</span><span id="link3"><e id="link3_tip">稍等15秒,缓冲中</e><!--d class="wait"><e id="span">3</e>s</d--></span></div></div><div class="yzmplayer-mask"></div>\n<div class="yzmplayer-cplayer"><div class="yzmplayer-showing"><a href="https://weixin.sogou.com/weixinwap?query=%E9%A1%B6%E7%A9%BA#tab_account" target="view_window" style="color:#ffffff;font-size:10px;line-height:14px;text-align:center;background-color:#e72525;padding:4px 4px;right: 85px;margin:20%;border-radius:10px;width:100px;position:absolute;box-shadow:0px 0px 5px 1px #e72525bd;font-weight:bold;">关注公众号支持一下</a><img src="https://ae01.alicdn.com/kf/U18ca2f7ef51149089f99be085c490af1Z.png" referrerpolicy="no-referrer" style="width: 80px;margin: -15px;"></div></div><div class="yzmplayer-video-wrap">\n    ',
            function(e) {
                t += e
            } (n(4)(a)),
            t += "\n    ",
            ...
            o.danmaku && o.danmaku.bottm && (t += ' style="margin-bottom:', t += s(o.danmaku.bottm), t += '"'),
            ...
            o.danmaku && (t += '\n        <span class="yzmplayer-danloading">', t += s(r("弹幕正在连接中")), t += "</span>\n        "),
            ...
            t += '" data-balloon-pos="up">\n            <span class="yzmplayer-icon-content">',
            t += l.send,
            t += '</span>\n        </button>\n<input id="dmtext" dmtype="right" class="yzm-yzmplayer-comment-input" type="text" placeholder="',
            t += s(r("来一发友善的弹幕")),
            t += '" maxlength="30">\n        <button class="yzmplayer-icon yzm-yzmplayer-send-icon" id="fasong" data-balloon="',
            t += s(r("发送")),
    ...
    function(e, t, n) {
        ...
        s = function() {
            ...
            },
            {
                ...
                value: function(e, t) {
                    for (var n = this,
                    i = [], a = 0, o = 0; o < e.length; ++o) this.options.apiBackend.read(e[o],
                    function(o) {
                        return function(s, r) {
                            if (++a, s) s.response ? n.options.error(s.response.msg) : n.options.error("弹幕加载失败：" + s.status),
                            i[o] = [];
                            else {
                ...
                value: function(e) {
                    ...
                    if (this.showing) {
                        ...
                        function(a) {
                            ...
                            case "right":
                                r = c(o, e[a].type, s),
                                r >= 0 && (o.style.width = s + 1 + "px", o.style.top = n * r + "px", o.style.transform = "translateX(-" + i + "px)");
                                break;
                            case "top":
                                r = c(o, e[a].type),
            ...
            },
            {
                ...
                value: function() {
                    ...
                    t = this.container.getElementsByClassName("yzmplayer-danmaku-item"), n = 0; n < t.length; n++) t[n].style.transform = "translateX(-" + e + "px)"
                }
            },
            {
                key: "hide",
            ...
            },
            {
                ...
                value: function() {
                    ...
                    default.getElementViewLeft(e.player.template.playedBarWrap)) / e.player.template.playedBarWrap.clientWidth;
                        ...
                        e.player.template.ptime.innerHTML = r.
                ...
                default.nameMap.dragMove,
                    function(t) {
                        ...
                        default.isMobile && e.thumbnails && e.thumbnails.show(),
                            ...
                            e.player.template.playedBarTime.innerText = r.
                        default.secondToTime(a),
        ...
        o = function() {
            ...
            },
            {
                ...
                value: function() {
                    ...
                    this.template.infoVersion.innerHTML = "1.1.0",
                    ...
                    this.player.options.danmaku && (this.template.infoDanmakuId.innerHTML = this.player.options.danmaku.id, this.template.infoDanmakuApi.innerHTML = this.player.options.danmaku.api, this.template.infoDanmakuAmount.innerHTML = this.player.danmaku.dan.length - 2)
                }
            },
            {
                key: "fps",
